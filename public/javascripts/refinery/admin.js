...
var link_dialog = {
  ...
  page_tab: function(){
    $('.link_list li').click(function(e){
      ...
      var datamodel = $(link).attr('data-model');
      var datapage = $(link).attr('data-page');

      link_dialog.update_parent(url, link.rel.replace(/\ ?<em>.+?<\/em>/, ''), '', datamodel, datapage);
    });
  },
  ...
  update_parent: function(url, title, target, datamodel, datapage) {
    if (parent != null) {
      ...
      if ((wym_data_model = parent.document.getElementById('wym_data_model')) != null) {
        wym_data_model.value = datamodel;
      }
      if ((wym_data_page = parent.document.getElementById('wym_data_page')) != null) {
        wym_data_page.value = datapage;
      }            
